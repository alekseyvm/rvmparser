...
namespace KdTree
{
  ...
  struct R3StaticTree
  {
    ...
    void getPointsWithinRadius(std::vector<QueryResult>& result, const Vec3f& origin, float radius);

    void getNearestNeighbours(std::vector<QueryResult>& result, const Vec3f& origin, uint32_t K);
  ...
  private:
    ...
    void getPointsWithinRadiusRecurse(std::vector<QueryResult>& result, uint32_t nodeIndex, const Vec3f& origin, float radius);

    void getNearestNeighboursRecurse(std::vector<QueryResult>& result, uint32_t nodeIx, const Vec3f& origin, uint32_t K);
